...
#    unittest.main(verbosity=2)
    ...
    work=cpnest.CPNest(model, verbose=2, nnest=4, nensemble=8, nlive=1000, maxmcmc=5000, nslice=0, nhamiltonian=0, resume=0)
    work.run()
    print("analytic logZ = {0}".format(model.analytic_log_Z))
    print("estimated logZ = {0}".format(work.logZ))
